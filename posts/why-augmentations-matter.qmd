...
date: 2026-03-18
categories: [self-supervised-learning, contrastive-learning, augmentations]
description: "Testing how different augmentation strategies affect representation quality in SimCLR-style contrastive learning."
image: figures/fig-aug-matrix.png
image-alt: "Augmentation recipe matrix: minimal, moderate, full, aggressive."
---
