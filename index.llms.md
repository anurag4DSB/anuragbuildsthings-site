...
[![Linear probe accuracy by augmentation recipe: 48.3 / 71.9 / 83.7 / 82.1%.](./posts/figures/fig-ablation.png)](posts/augmentations-are-the-model.llms.md)
...
[![Four pretext tasks: contrastive, masked, predictive, denoising.](./posts/figures/fig-ssl-overview.png)](posts/self-supervised-learning.llms.md)
...
[![SimCLR diagram: two augmented views, encoder, projection, embedding space.](./posts/figures/fig-simclr.png)](posts/ssl-representation.llms.md)
...
[![Augmentation recipe matrix: minimal, moderate, full, aggressive.](./posts/figures/fig-aug-matrix.png)](posts/why-augmentations-matter.llms.md)
